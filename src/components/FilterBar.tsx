...
export default function FilterBar({ filters, categories, locations, batches, onChange }: FilterBarProps) {
  ...
  const selectClass = "w-full sm:w-auto sm:flex-1 h-[44px] min-w-[140px] appearance-none rounded-[6px] border border-line bg-surface px-4 py-2 text-sm font-medium text-foreground transition-colors duration-150 hover:border-purple/40 focus:border-purple focus:outline-none bg-no-repeat cursor-pointer";
